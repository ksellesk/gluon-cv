...
if __name__ == '__main__':
    ...
    net = gcv.model_zoo.get_model("yolo3_darknet53_custom", classes=["person"], pretrained=False, pretrained_base=False)
    net.load_parameters("yolo3_darknet53_custom_best.params")
